...
public class ExoMediaVideoPlayDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exo_media_video_play_detail);
    ...
    private void init() {
        ...
        videoPlayer.setUp(videoUrl, false, "测试视频");
        //增加封面
